                ...
                {filtered.map((po) => (
                  <tr key={po._id} className="hover:bg-slate-50/50 transition-all">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-0.5">Project: {po.projectId}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-5">
                    ...
                    <td className="px-6 py-5 text-center">
                      {po.qcStatus === 'Passed' && (
                        <span className="px-3 py-1 bg-emerald-100 text-emerald-600 rounded-full text-xs font-black uppercase tracking-widest">GOODS PASSED</span>
                      )}
                      {po.qcStatus === 'Returned' && (
                        <span className="px-3 py-1 bg-rose-100 text-rose-600 rounded-full text-xs font-black uppercase tracking-widest">RETURNED</span>
                      )}
                      {po.qcStatus === 'Waiting Delivery' && (
                        <span className="px-3 py-1 bg-amber-100 text-amber-600 rounded-full text-xs font-black uppercase tracking-widest">WAITING RECEIPT</span>
                      )}
                    </td>
                    <td className="px-6 py-5 text-right">
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 text-emerald-600 rounded-lg font-black text-xs uppercase tracking-widest hover:bg-emerald-50 hover:border-emerald-400 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                        >
                        ...
                        <button
                          ...
                          disabled={po.qcStatus === 'Passed'}
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 text-rose-500 rounded-lg font-black text-xs uppercase tracking-widest hover:bg-rose-50 hover:border-rose-400 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                        >
