                ...
                {filtered.map((it, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-slate-50/50 transition-all">
                      ...
                      <td className="px-6 py-5">
                        <span className="px-2 py-1 rounded-full text-2xs font-black uppercase bg-sky-100 text-sky-600">
                          {it.category}
                        </span>
                      </td>
                      <td className="px-6 py-5 text-center font-black text-slate-700">{it.initialQty} <span className="text-2xs text-slate-400">{it.unit}</span></td>
                      ...
                      <td className="px-6 py-5">
                        <div className="w-32">
                          ...
                          <p className="text-2xs font-black text-slate-400 mt-1">{pct}% tersisa</p>
                        </div>
                      </td>
                      <td className="px-6 py-5 text-center">
                        {bacaSaja ? (
                          <span className="text-2xs font-black text-slate-300 uppercase tracking-widest">—</span>
                        ) : (
                          <button
