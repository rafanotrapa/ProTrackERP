    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <div className="w-full border-b border-slate-100 px-8 py-8 flex items-center gap-6 bg-white shadow-sm z-10">
        ...
        <div>
          ...
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1 italic leading-none">Procurement Module • Billing Forwarder</p>
        </div>
      </div>

      <main className="flex-1 p-8 md:p-12 lg:p-16 max-w-5xl mx-auto w-full">
        <div className="flex justify-between items-end mb-6 px-2">
          <h2 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] italic leading-none">Invoice Operations</h2>
        </div>
