...
const InvoiceSubmission = () => {
  ...
  const calculateGrandTotal = () => {
    ...
    const tax = formData.isTaxEnabled ? (Number(formData.taxAmount) || 0) : 0;
    const duty = formData.isImportEnabled ? (Number(formData.importDutyAmount) || 0) : 0;
    return base + tax + duty;
  };
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="mt-6 flex justify-between items-center bg-indigo-50 border border-indigo-200 p-5 rounded-2xl shadow-sm">
                   <span className="text-[11px] font-black text-indigo-800 uppercase tracking-[0.2em] italic">Grand Total Billing</span>
