                ...
                {filtered.map((p) => (
                  <tr key={p._id} className="hover:bg-slate-50/50 transition-all">
                    <td className="px-6 py-5">
                      ...
                      <p className="text-[12px] font-bold text-slate-700 mt-0.5">{p.projectName}</p>
                      <p className="text-[11px] text-slate-400">{p.institutionName}</p>
                    </td>
                    <td className="px-6 py-5">
                      <p className="font-bold text-slate-700 text-sm">{p.clientName}</p>
                      <p className="text-[11px] text-slate-400">{p.clientContact}</p>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-1.5">
                        {p.createdBy ? (
                          <p className="font-bold text-slate-700 text-[13px]">{p.createdBy.username}</p>
                        ) : (
                          <p className="text-[12px] font-bold text-slate-300 italic">Belum ada</p>
                        )}
                        {bolehUbahPIC && (
                          <button
                    ...
                    <td className="px-6 py-5 text-center">
                      <span className={`px-3 py-1 rounded-full text-[11px] font-black ${statusBadge(p.status)}`}>
                        {p.status || 'Tendering'}
                      </span>
                    </td>
                    <td className="px-6 py-5 text-center">
                    ...
                    <td className="px-6 py-5 text-center">
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-900 text-white rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all"
                      >
                        Timeline
                      </button>
                    </td>
