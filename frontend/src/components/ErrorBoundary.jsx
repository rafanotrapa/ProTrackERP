        ...
        <div className="max-w-lg w-full text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-xl bg-slate-900 hover:bg-indigo-700 text-white text-[10px] font-black uppercase tracking-widest transition-all"
            >
              <RotateCw size={14} /> Muat Ulang
            </button>
            <button
              onClick={() => { window.location.href = '/dashboard'; }}
              className="flex items-center gap-2 px-5 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-[10px] font-black uppercase tracking-widest transition-all"
            >
          ...
          <details className="mt-8 text-left">
            <summary className="cursor-pointer text-[9px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-600">
              Rincian teknis
            </summary>
            <pre className="mt-3 p-4 bg-slate-50 border border-slate-200 rounded-xl text-[10px] text-slate-600 overflow-x-auto whitespace-pre-wrap break-words">
