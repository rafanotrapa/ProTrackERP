      ...
      <main className="flex-1 p-8 md:p-12">
        <form onSubmit={handleSubmit} className="max-w-6xl space-y-10">
                  ...
                  {formData.items.map((item, index) => (
                    <div key={index} className="grid grid-cols-12 gap-4 p-5 bg-slate-50 rounded-2xl border border-slate-200 items-end">
                      <div className="col-span-4 space-y-1">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest">Item Name</label>
              ...
              <div className="space-y-4">
                {manualItems.map((item) => (
                  <div key={item.id} className="grid grid-cols-12 gap-3 p-5 bg-slate-50 rounded-2xl border border-slate-200 items-end">
                    ...
                    <div className="col-span-2 space-y-1">
                      <label className="text-xs font-black text-emerald-600 uppercase tracking-widest">Sales Price *</label>
                      <input
                        type="text"
                        value={formatRupiah(item.salesPrice)}
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-indigo-600 font-black text-xs uppercase tracking-widest hover:text-indigo-800 transition-colors mt-2"
                >
                  + Add Item
                </button>
              </div>
              ...
              <div className="text-right w-80 space-y-2">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <input
                    ...
                    className={`w-40 p-2 bg-white border rounded-lg font-bold text-right transition-colors ${
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1 italic">Currency</label>
                <StyledSelect
                  name="currency"
          ...
          <div className="flex justify-end gap-4 pt-8 border-t border-slate-100">
            <button
              ...
              className={`px-6 py-4 rounded-xl font-black text-slate-600 uppercase tracking-widest text-xs border-2 border-slate-300 transition-all active:scale-95 ${
