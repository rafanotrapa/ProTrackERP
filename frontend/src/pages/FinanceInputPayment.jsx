    ...
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <div className="w-full border-b border-slate-100 px-6 md:px-10 py-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mt-0.5 italic">Record Client Payment • Upload Evidence</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <div>
                ...
                {unpaidStages.length === 0 && selectedProject && (
                  <p className="text-xs text-amber-600 mt-2">No unpaid invoices for this project</p>
                )}
              </div>
            </div>
          )}
          ...
          {selectedInvoice && (
            <div className="bg-linear-to-r from-slate-800 to-slate-900 rounded-2xl p-6 text-white shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5 pt-5 border-t border-white/10">
                <div>
                  <p className="text-2xs font-black text-slate-400 uppercase tracking-widest">Client Name</p>
                  <p className="font-bold text-sm uppercase">{selectedProject?.clientName || '-'}</p>
                </div>
                <div>
                  <p className="text-2xs font-black text-slate-400 uppercase tracking-widest">Project</p>
          ...
          {selectedInvoice && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Payment Evidence <span className="text-red-500">*</span></label>
                  <div className="relative mt-1 group">
                    ...
                    />
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-black uppercase text-indigo-500 pointer-events-none">
                      Upload File →
                    </div>
                  </div>
                  <p className="text-2xs text-slate-400 mt-1">Accepted formats: JPG, PNG, PDF</p>
                </div>

                <div>
                  <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Remarks / Notes (Optional)</label>
                  <textarea
                    name="remarks"
                    rows="3"
          ...
          <div className="flex justify-end pt-4">
            <button
              ...
              className={`px-8 py-4 rounded-xl font-black text-white uppercase tracking-widest text-xs shadow-lg transition-all active:scale-95 ${
