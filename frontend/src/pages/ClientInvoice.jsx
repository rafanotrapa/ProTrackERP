      ...
      <div className="w-full border-b border-slate-100 px-8 py-8 flex flex-col md:flex-row md:items-center justify-between bg-slate-50/30 gap-6">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-xs font-black text-slate-400 uppercase tracking-widest mt-1 italic leading-none">
              ...
              filteredInvoices.map((inv) => (
                ...
                >
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <span className={`px-4 py-1.5 rounded-full text-xs font-black uppercase italic border ${
                  ...
                  <div className="space-y-1 mb-8">
                    <p className="text-sm font-black text-indigo-600 uppercase italic tracking-widest">
                  ...
                  <div className="py-6 border-y border-dashed border-slate-200 mb-8">
                    <p className="text-xs font-black text-slate-400 uppercase italic mb-1 tracking-widest">
                  ...
                  <div className="flex gap-4">
                    ...
                    >
                      <Download size={18} />
                      <span className="text-xs font-black uppercase italic text-slate-600">PDF</span>
                    </button>
                    ...
                    {String(inv?.status || '').toLowerCase() !== 'paid' && (
                      ...
                      >
                        <span className="text-xs font-black uppercase italic">Process</span>
