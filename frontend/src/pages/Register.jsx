          ...
          <form onSubmit={handleRegister} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
              ...
              {formData.role === 'Super Admin' && (
                <div className="md:col-span-2">
                  <p className="text-xs font-bold text-amber-600 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
            ...
            <div className="pt-4 flex flex-col md:flex-row gap-4">
              ...
              <button
                type="button"
                onClick={() => navigate('/manage-users')}
                className="flex-1 bg-slate-100 text-slate-400 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-200 transition-all"
              >
                Cancel
              </button>
            </div>
